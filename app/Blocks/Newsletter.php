...
class Newsletter extends Block
{
    ...
    public function fields()
    {
        ...
        $newsletter
            ...
            ->addText('shortcode', [
                ...
                'instructions' => 'Wklej kod formularza: [contact-form-7 id="907a6a3" title="Newsletter"]',
            ])
    ...
    {
        $fields = [
            'g_newsletter' => get_field('g_newsletter'),
